/*
******************************************************************************************
*** This SQL script creates the database structure for a fictional store called Tmart. ***
****************************************************************************************** 
*/

/*
| ============================================================================
| Temporarily disable constraint checks and save old settings
| ============================================================================
| Save the current UNIQUE_CHECKS setting, then disable unique checks
| This can improve performance while creating/loading tables
| 
| Save the current FOREIGN_KEY_CHECKS setting, then disable foreign key checks
| This prevents dependency issues while creating related tables
| 
| Save the current SQL mode and apply stricter validation rules
| ============================================================================
*/
...
-- Select the tmart database for use
USE tmart;

/*
| =========================================================
| Customers table: tmart.customers
...
/*
| =========================================================
| Product categories table: tmart.products_categories
| High-level product groupings
| =========================================================
*/
...
/*
| =========================================================
| Product subcategories table: tmart.products_subcategories
| Child categories connected to a parent category
| =========================================================
*/
...
/*
| =========================================================
| Products table: tmart.products
| Stores individual products available for sale
| =========================================================
*/
...
/*
| =========================================================
| Order items table: tmart.order_items
