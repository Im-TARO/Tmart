...
<table>
  <tr>
    <td align="center" width="50%">
      <h2>📁 Tmart's transactional DB</h2>
      <p>Create the DB structure for Tmart</p><br/>
      🔗 <a href="docs/tmart_db.md">Documentation</a>
      <br/>
      <sub>MySQL, Python, ChatGPT</sub>
    </td>
    <td align="center" width="50%">
      <h2>⭐ SQL Data Warehouse</h2>
      <p>Make the data ready for analytics, enabling BI reporting and dashboards</p>
      🔗 <a href="docs/data_warehouse.md">Documentation</a>
      <br/>
      <sub>MySQL, Star Schema</sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
